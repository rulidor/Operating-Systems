...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	43858593          	addi	a1,a1,1080 # 1448 <csem_up+0x48>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	14c080e7          	jalr	332(ra) # 1166 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	3f258593          	addi	a1,a1,1010 # 1450 <csem_up+0x50>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	0fe080e7          	jalr	254(ra) # 1166 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	3c050513          	addi	a0,a0,960 # 1458 <csem_up+0x58>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	49470713          	addi	a4,a4,1172 # 1558 <csem_up+0x158>
    ...
    panic("runcmd");
      ...
      e2:	38250513          	addi	a0,a0,898 # 1460 <csem_up+0x60>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	36858593          	addi	a1,a1,872 # 1468 <csem_up+0x68>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	05c080e7          	jalr	92(ra) # 1166 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	32c58593          	addi	a1,a1,812 # 1478 <csem_up+0x78>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	010080e7          	jalr	16(ra) # 1166 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	2a650513          	addi	a0,a0,678 # 1488 <csem_up+0x88>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	fce080e7          	jalr	-50(ra) # 1252 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f84080e7          	jalr	-124(ra) # 1252 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f2a080e7          	jalr	-214(ra) # 1252 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	ee4080e7          	jalr	-284(ra) # 1252 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	ea2080e7          	jalr	-350(ra) # 1252 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	1b698993          	addi	s3,s3,438 # 15b0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	15298993          	addi	s3,s3,338 # 15b0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	0e898993          	addi	s3,s3,232 # 15b0 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	0d8a8a93          	addi	s5,s5,216 # 15a8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	07e98993          	addi	s3,s3,126 # 15b0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	f0eb8b93          	addi	s7,s7,-242 # 14b0 <csem_up+0xb0>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	edc50513          	addi	a0,a0,-292 # 1490 <csem_up+0x90>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	e1c60613          	addi	a2,a2,-484 # 14b8 <csem_up+0xb8>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	e0cb0b13          	addi	s6,s6,-500 # 14d8 <csem_up+0xd8>
  ...
  return ret;
     ...
     70a:	dba50513          	addi	a0,a0,-582 # 14c0 <csem_up+0xc0>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	d6050513          	addi	a0,a0,-672 # 14c8 <csem_up+0xc8>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	d3e60613          	addi	a2,a2,-706 # 14e0 <csem_up+0xe0>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	cd6a0a13          	addi	s4,s4,-810 # 14e8 <csem_up+0xe8>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	ca860613          	addi	a2,a2,-856 # 14f0 <csem_up+0xf0>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	c0a60613          	addi	a2,a2,-1014 # 14b8 <csem_up+0xb8>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	c2a60613          	addi	a2,a2,-982 # 1508 <csem_up+0x108>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	bd850513          	addi	a0,a0,-1064 # 14f8 <csem_up+0xf8>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	be050513          	addi	a0,a0,-1056 # 1510 <csem_up+0x110>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	c1470713          	addi	a4,a4,-1004 # 1570 <csem_up+0x170>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	b2060613          	addi	a2,a2,-1248 # 1528 <csem_up+0x128>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	af258593          	addi	a1,a1,-1294 # 1530 <csem_up+0x130>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	71e080e7          	jalr	1822(ra) # 1166 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	a7050513          	addi	a0,a0,-1424 # 14c0 <csem_up+0xc0>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	ace48493          	addi	s1,s1,-1330 # 1540 <csem_up+0x140>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	b2848493          	addi	s1,s1,-1240 # 15c0 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	b1ba0a13          	addi	s4,s4,-1253 # 15c3 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	a98a8a93          	addi	s5,s5,-1384 # 1548 <csem_up+0x148>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	63e080e7          	jalr	1598(ra) # 1166 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	a8e50513          	addi	a0,a0,-1394 # 15c0 <buf.0>
...
0000000000000e9a <kthread_create>:
...
0000000000000eb2 <kthread_join>:
.global kthread_join
kthread_join:
 li a7, SYS_kthread_join
     eb2:	02000893          	li	a7,32
 ecall
     eb6:	00000073          	ecall
 ret
     eba:	8082                	ret
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ed2:	f14080e7          	jalr	-236(ra) # de2 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ef0:	0805c863          	bltz	a1,f80 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f04:	69050513          	addi	a0,a0,1680 # 1590 <digits>
     f08:	883a                	mv	a6,a4
  ...
  if(neg)
     f2c:	00088b63          	beqz	a7,f42 <printint+0x64>
    buf[i++] = '-';
     f30:	fd040793          	addi	a5,s0,-48
     f34:	973e                	add	a4,a4,a5
     f36:	02d00793          	li	a5,45
     f3a:	fef70823          	sb	a5,-16(a4)
     f3e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f42:	02e05863          	blez	a4,f72 <printint+0x94>
    ...
    putc(fd, buf[i]);
     ...
     f68:	f58080e7          	jalr	-168(ra) # ebc <putc>
  while(--i >= 0)
     f6c:	197d                	addi	s2,s2,-1
     f6e:	ff3918e3          	bne	s2,s3,f5e <printint+0x80>
}
...
{
     f88:	7119                	addi	sp,sp,-128
     f8a:	fc86                	sd	ra,120(sp)
     f8c:	f8a2                	sd	s0,112(sp)
     f8e:	f4a6                	sd	s1,104(sp)
     f90:	f0ca                	sd	s2,96(sp)
     f92:	ecce                	sd	s3,88(sp)
     f94:	e8d2                	sd	s4,80(sp)
     f96:	e4d6                	sd	s5,72(sp)
     f98:	e0da                	sd	s6,64(sp)
     f9a:	fc5e                	sd	s7,56(sp)
     f9c:	f862                	sd	s8,48(sp)
     f9e:	f466                	sd	s9,40(sp)
     fa0:	f06a                	sd	s10,32(sp)
     fa2:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     faa:	18090f63          	beqz	s2,1148 <vprintf+0x1c0>
     fae:	8aaa                	mv	s5,a0
     fb0:	8b32                	mv	s6,a2
     fb2:	00158493          	addi	s1,a1,1
  state = 0;
     fb6:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
     ...
     fc4:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     fc8:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fcc:	00000b97          	auipc	s7,0x0
     fd0:	5c4b8b93          	addi	s7,s7,1476 # 1590 <digits>
     fd4:	a839                	j	ff2 <vprintf+0x6a>
        putc(fd, c);
     fd6:	85ca                	mv	a1,s2
     fd8:	8556                	mv	a0,s5
     fda:	00000097          	auipc	ra,0x0
     fde:	ee2080e7          	jalr	-286(ra) # ebc <putc>
     fe2:	a019                	j	fe8 <vprintf+0x60>
    } else if(state == '%'){
     fe4:	01498f63          	beq	s3,s4,1002 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fe8:	0485                	addi	s1,s1,1
     fea:	fff4c903          	lbu	s2,-1(s1)
     fee:	14090d63          	beqz	s2,1148 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     ff2:	0009079b          	sext.w	a5,s2
    if(state == 0){
     ff6:	fe0997e3          	bnez	s3,fe4 <vprintf+0x5c>
      if(c == '%'){
     ffa:	fd479ee3          	bne	a5,s4,fd6 <vprintf+0x4e>
        state = '%';
     ffe:	89be                	mv	s3,a5
    1000:	b7e5                	j	fe8 <vprintf+0x60>
      if(c == 'd'){
    1002:	05878063          	beq	a5,s8,1042 <vprintf+0xba>
      } else if(c == 'l') {
    1006:	05978c63          	beq	a5,s9,105e <vprintf+0xd6>
      } else if(c == 'x') {
    100a:	07a78863          	beq	a5,s10,107a <vprintf+0xf2>
      } else if(c == 'p') {
    100e:	09b78463          	beq	a5,s11,1096 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    1012:	07300713          	li	a4,115
    1016:	0ce78663          	beq	a5,a4,10e2 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    101a:	06300713          	li	a4,99
    101e:	0ee78e63          	beq	a5,a4,111a <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1022:	11478863          	beq	a5,s4,1132 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    102e:	e92080e7          	jalr	-366(ra) # ebc <putc>
        putc(fd, c);
    1032:	85ca                	mv	a1,s2
    1034:	8556                	mv	a0,s5
    1036:	00000097          	auipc	ra,0x0
    103a:	e86080e7          	jalr	-378(ra) # ebc <putc>
      }
      state = 0;
    103e:	4981                	li	s3,0
    1040:	b765                	j	fe8 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    1054:	e8e080e7          	jalr	-370(ra) # ede <printint>
    1058:	8b4a                	mv	s6,s2
      state = 0;
    105a:	4981                	li	s3,0
    105c:	b771                	j	fe8 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    1070:	e72080e7          	jalr	-398(ra) # ede <printint>
    1074:	8b4a                	mv	s6,s2
      state = 0;
    1076:	4981                	li	s3,0
    1078:	bf85                	j	fe8 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    108c:	e56080e7          	jalr	-426(ra) # ede <printint>
    1090:	8b4a                	mv	s6,s2
      state = 0;
    1092:	4981                	li	s3,0
    1094:	bf91                	j	fe8 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    10ac:	e14080e7          	jalr	-492(ra) # ebc <putc>
  putc(fd, 'x');
    10b0:	85ea                	mv	a1,s10
    10b2:	8556                	mv	a0,s5
    10b4:	00000097          	auipc	ra,0x0
    10b8:	e08080e7          	jalr	-504(ra) # ebc <putc>
    10bc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10be:	03c9d793          	srli	a5,s3,0x3c
    10c2:	97de                	add	a5,a5,s7
    10c4:	0007c583          	lbu	a1,0(a5)
    10c8:	8556                	mv	a0,s5
    10ca:	00000097          	auipc	ra,0x0
    10ce:	df2080e7          	jalr	-526(ra) # ebc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10d2:	0992                	slli	s3,s3,0x4
    10d4:	397d                	addiw	s2,s2,-1
    10d6:	fe0914e3          	bnez	s2,10be <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10da:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10de:	4981                	li	s3,0
    10e0:	b721                	j	fe8 <vprintf+0x60>
        s = va_arg(ap, char*);
    10e2:	008b0993          	addi	s3,s6,8
    10e6:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10ea:	02090163          	beqz	s2,110c <vprintf+0x184>
        while(*s != 0){
    10ee:	00094583          	lbu	a1,0(s2)
    10f2:	c9a1                	beqz	a1,1142 <vprintf+0x1ba>
          putc(fd, *s);
    10f4:	8556                	mv	a0,s5
    10f6:	00000097          	auipc	ra,0x0
    10fa:	dc6080e7          	jalr	-570(ra) # ebc <putc>
          s++;
    10fe:	0905                	addi	s2,s2,1
        while(*s != 0){
    1100:	00094583          	lbu	a1,0(s2)
    1104:	f9e5                	bnez	a1,10f4 <vprintf+0x16c>
        s = va_arg(ap, char*);
    1106:	8b4e                	mv	s6,s3
      state = 0;
    1108:	4981                	li	s3,0
    110a:	bdf9                	j	fe8 <vprintf+0x60>
          s = "(null)";
    110c:	00000917          	auipc	s2,0x0
    1110:	47c90913          	addi	s2,s2,1148 # 1588 <csem_up+0x188>
        while(*s != 0){
    1114:	02800593          	li	a1,40
    1118:	bff1                	j	10f4 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    111a:	008b0913          	addi	s2,s6,8
    111e:	000b4583          	lbu	a1,0(s6)
    1122:	8556                	mv	a0,s5
    1124:	00000097          	auipc	ra,0x0
    1128:	d98080e7          	jalr	-616(ra) # ebc <putc>
    112c:	8b4a                	mv	s6,s2
      state = 0;
    112e:	4981                	li	s3,0
    1130:	bd65                	j	fe8 <vprintf+0x60>
        putc(fd, c);
    1132:	85d2                	mv	a1,s4
    1134:	8556                	mv	a0,s5
    1136:	00000097          	auipc	ra,0x0
    113a:	d86080e7          	jalr	-634(ra) # ebc <putc>
      state = 0;
    113e:	4981                	li	s3,0
    1140:	b565                	j	fe8 <vprintf+0x60>
        s = va_arg(ap, char*);
    1142:	8b4e                	mv	s6,s3
      state = 0;
    1144:	4981                	li	s3,0
    1146:	b54d                	j	fe8 <vprintf+0x60>
    }
  }
}
    1148:	70e6                	ld	ra,120(sp)
    114a:	7446                	ld	s0,112(sp)
    114c:	74a6                	ld	s1,104(sp)
    114e:	7906                	ld	s2,96(sp)
    1150:	69e6                	ld	s3,88(sp)
    1152:	6a46                	ld	s4,80(sp)
    1154:	6aa6                	ld	s5,72(sp)
    1156:	6b06                	ld	s6,64(sp)
    1158:	7be2                	ld	s7,56(sp)
    115a:	7c42                	ld	s8,48(sp)
    115c:	7ca2                	ld	s9,40(sp)
    115e:	7d02                	ld	s10,32(sp)
    1160:	6de2                	ld	s11,24(sp)
    1162:	6109                	addi	sp,sp,128
    1164:	8082                	ret

0000000000001166 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1166:	715d                	addi	sp,sp,-80
    1168:	ec06                	sd	ra,24(sp)
    116a:	e822                	sd	s0,16(sp)
    116c:	1000                	addi	s0,sp,32
    116e:	e010                	sd	a2,0(s0)
    1170:	e414                	sd	a3,8(s0)
    1172:	e818                	sd	a4,16(s0)
    1174:	ec1c                	sd	a5,24(s0)
    1176:	03043023          	sd	a6,32(s0)
    117a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    117e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1182:	8622                	mv	a2,s0
    1184:	00000097          	auipc	ra,0x0
    1188:	e04080e7          	jalr	-508(ra) # f88 <vprintf>
}
    118c:	60e2                	ld	ra,24(sp)
    118e:	6442                	ld	s0,16(sp)
    1190:	6161                	addi	sp,sp,80
    1192:	8082                	ret

0000000000001194 <printf>:

void
printf(const char *fmt, ...)
{
    1194:	711d                	addi	sp,sp,-96
    1196:	ec06                	sd	ra,24(sp)
    1198:	e822                	sd	s0,16(sp)
    119a:	1000                	addi	s0,sp,32
    119c:	e40c                	sd	a1,8(s0)
    119e:	e810                	sd	a2,16(s0)
    11a0:	ec14                	sd	a3,24(s0)
    11a2:	f018                	sd	a4,32(s0)
    11a4:	f41c                	sd	a5,40(s0)
    11a6:	03043823          	sd	a6,48(s0)
    11aa:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    11ae:	00840613          	addi	a2,s0,8
    11b2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    11b6:	85aa                	mv	a1,a0
    11b8:	4505                	li	a0,1
    11ba:	00000097          	auipc	ra,0x0
    11be:	dce080e7          	jalr	-562(ra) # f88 <vprintf>
}
    11c2:	60e2                	ld	ra,24(sp)
    11c4:	6442                	ld	s0,16(sp)
    11c6:	6125                	addi	sp,sp,96
    11c8:	8082                	ret

00000000000011ca <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    11ca:	1141                	addi	sp,sp,-16
    11cc:	e422                	sd	s0,8(sp)
    11ce:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11d0:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11d4:	00000797          	auipc	a5,0x0
    11d8:	3e47b783          	ld	a5,996(a5) # 15b8 <freep>
    11dc:	a805                	j	120c <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11de:	4618                	lw	a4,8(a2)
    11e0:	9db9                	addw	a1,a1,a4
    11e2:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11e6:	6398                	ld	a4,0(a5)
    11e8:	6318                	ld	a4,0(a4)
    11ea:	fee53823          	sd	a4,-16(a0)
    11ee:	a091                	j	1232 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11f0:	ff852703          	lw	a4,-8(a0)
    11f4:	9e39                	addw	a2,a2,a4
    11f6:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11f8:	ff053703          	ld	a4,-16(a0)
    11fc:	e398                	sd	a4,0(a5)
    11fe:	a099                	j	1244 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1200:	6398                	ld	a4,0(a5)
    1202:	00e7e463          	bltu	a5,a4,120a <free+0x40>
    1206:	00e6ea63          	bltu	a3,a4,121a <free+0x50>
{
    120a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    120c:	fed7fae3          	bgeu	a5,a3,1200 <free+0x36>
    1210:	6398                	ld	a4,0(a5)
    1212:	00e6e463          	bltu	a3,a4,121a <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1216:	fee7eae3          	bltu	a5,a4,120a <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    ...
    122a:	fae60ae3          	beq	a2,a4,11de <free+0x14>
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    123e:	fae689e3          	beq	a3,a4,11f0 <free+0x26>
  } else
    p->s.ptr = bp;
    1242:	e394                	sd	a3,0(a5)
  freep = p;
    1244:	00000717          	auipc	a4,0x0
    1248:	36f73a23          	sd	a5,884(a4) # 15b8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    127a:	34253503          	ld	a0,834(a0) # 15b8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12a2:	31a90913          	addi	s2,s2,794 # 15b8 <freep>
  if(p == (char*)-1)
    12a6:	5afd                	li	s5,-1
    12a8:	a895                	j	131c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12aa:	00000797          	auipc	a5,0x0
    12ae:	37e78793          	addi	a5,a5,894 # 1628 <base>
    12b2:	00000717          	auipc	a4,0x0
    12b6:	30f73323          	sd	a5,774(a4) # 15b8 <freep>
    ...
    12de:	2ca73f23          	sd	a0,734(a4) # 15b8 <freep>
      return (void*)(p + 1);
  ...
  free((void*)(hp + 1));
    ...
    130a:	ec4080e7          	jalr	-316(ra) # 11ca <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    132c:	b22080e7          	jalr	-1246(ra) # e4a <sbrk>
  if(p == (char*)-1)
...
int csem_alloc(struct counting_semaphore *Csem, int initVal){
    1338:	7179                	addi	sp,sp,-48
    133a:	f406                	sd	ra,40(sp)
    133c:	f022                	sd	s0,32(sp)
    133e:	ec26                	sd	s1,24(sp)
    1340:	e84a                	sd	s2,16(sp)
    1342:	e44e                	sd	s3,8(sp)
    ...
    134e:	b30080e7          	jalr	-1232(ra) # e7a <bsem_alloc>
    1352:	84aa                	mv	s1,a0
    int Bsem2 = bsem_alloc();
    1354:	00000097          	auipc	ra,0x0
    1358:	b26080e7          	jalr	-1242(ra) # e7a <bsem_alloc>
    if( Bsem1 == -1 || Bsem2 == -1) // one of the semaphores is not valid
    135c:	57fd                	li	a5,-1
    135e:	00f48b63          	beq	s1,a5,1374 <csem_alloc+0x3c>
    1362:	02f50163          	beq	a0,a5,1384 <csem_alloc+0x4c>
        return -1;

    Csem->Bsem1 = Bsem1;
    1366:	00992023          	sw	s1,0(s2)
    Csem->Bsem2 = Bsem2;
    136a:	00a92223          	sw	a0,4(s2)
    Csem->value = initVal;
    136e:	01392423          	sw	s3,8(s2)
    return 0;
    1372:	4481                	li	s1,0
}
    1374:	8526                	mv	a0,s1
    1376:	70a2                	ld	ra,40(sp)
    1378:	7402                	ld	s0,32(sp)
    137a:	64e2                	ld	s1,24(sp)
    137c:	6942                	ld	s2,16(sp)
    137e:	69a2                	ld	s3,8(sp)
    1380:	6145                	addi	sp,sp,48
    1382:	8082                	ret
        return -1;
    1384:	84aa                	mv	s1,a0
    1386:	b7fd                	j	1374 <csem_alloc+0x3c>

0000000000001388 <csem_free>:
...
void csem_free(struct counting_semaphore *Csem){
    ...
    138e:	e426                	sd	s1,8(sp)
    1390:	1000                	addi	s0,sp,32
    1392:	84aa                	mv	s1,a0
    bsem_free(Csem->Bsem1);
    1394:	4108                	lw	a0,0(a0)
    1396:	00000097          	auipc	ra,0x0
    139a:	aec080e7          	jalr	-1300(ra) # e82 <bsem_free>
    bsem_free(Csem->Bsem2);
    139e:	40c8                	lw	a0,4(s1)
    13a0:	00000097          	auipc	ra,0x0
    13a4:	ae2080e7          	jalr	-1310(ra) # e82 <bsem_free>
}
    13a8:	60e2                	ld	ra,24(sp)
    13aa:	6442                	ld	s0,16(sp)
    13ac:	64a2                	ld	s1,8(sp)
    13ae:	6105                	addi	sp,sp,32
    13b0:	8082                	ret

00000000000013b2 <csem_down>:
...
void csem_down(struct counting_semaphore *Csem){
    ...
    13be:	4148                	lw	a0,4(a0)
    13c0:	00000097          	auipc	ra,0x0
    13c4:	aca080e7          	jalr	-1334(ra) # e8a <bsem_down>
    bsem_down(Csem->Bsem1);
    13c8:	4088                	lw	a0,0(s1)
    13ca:	00000097          	auipc	ra,0x0
    13ce:	ac0080e7          	jalr	-1344(ra) # e8a <bsem_down>
    Csem->value--;
    13d2:	449c                	lw	a5,8(s1)
    13d4:	37fd                	addiw	a5,a5,-1
    13d6:	0007871b          	sext.w	a4,a5
    13da:	c49c                	sw	a5,8(s1)
    if(Csem->value >0){
    13dc:	00e04c63          	bgtz	a4,13f4 <csem_down+0x42>
        bsem_up(Csem->Bsem2);
    }
    bsem_up(Csem->Bsem1);
    13e0:	4088                	lw	a0,0(s1)
    13e2:	00000097          	auipc	ra,0x0
    13e6:	ab0080e7          	jalr	-1360(ra) # e92 <bsem_up>
}
    13ea:	60e2                	ld	ra,24(sp)
    13ec:	6442                	ld	s0,16(sp)
    13ee:	64a2                	ld	s1,8(sp)
    13f0:	6105                	addi	sp,sp,32
    13f2:	8082                	ret
        bsem_up(Csem->Bsem2);
    13f4:	40c8                	lw	a0,4(s1)
    13f6:	00000097          	auipc	ra,0x0
    13fa:	a9c080e7          	jalr	-1380(ra) # e92 <bsem_up>
    13fe:	b7cd                	j	13e0 <csem_down+0x2e>

0000000000001400 <csem_up>:



void csem_up(struct counting_semaphore *Csem){
    1400:	1101                	addi	sp,sp,-32
    1402:	ec06                	sd	ra,24(sp)
    1404:	e822                	sd	s0,16(sp)
    1406:	e426                	sd	s1,8(sp)
    1408:	1000                	addi	s0,sp,32
    140a:	84aa                	mv	s1,a0
    bsem_down(Csem->Bsem1);
    140c:	4108                	lw	a0,0(a0)
    140e:	00000097          	auipc	ra,0x0
    1412:	a7c080e7          	jalr	-1412(ra) # e8a <bsem_down>
    Csem->value++;
    1416:	449c                	lw	a5,8(s1)
    1418:	2785                	addiw	a5,a5,1
    141a:	0007871b          	sext.w	a4,a5
    141e:	c49c                	sw	a5,8(s1)
    if(Csem->value ==1){
    1420:	4785                	li	a5,1
    1422:	00f70c63          	beq	a4,a5,143a <csem_up+0x3a>
        bsem_up(Csem->Bsem2);
    }
    bsem_up(Csem->Bsem1);
    1426:	4088                	lw	a0,0(s1)
    1428:	00000097          	auipc	ra,0x0
    142c:	a6a080e7          	jalr	-1430(ra) # e92 <bsem_up>
    ...
    1438:	8082                	ret
        bsem_up(Csem->Bsem2);
    143a:	40c8                	lw	a0,4(s1)
    143c:	00000097          	auipc	ra,0x0
    1440:	a56080e7          	jalr	-1450(ra) # e92 <bsem_up>
    1444:	b7cd                	j	1426 <csem_up+0x26>
