...
forktest(void)
{
  ...
  3e:	40e50513          	addi	a0,a0,1038 # 448 <set_priority+0xc>
  ...
  68:	3f450513          	addi	a0,a0,1012 # 458 <set_priority+0x1c>
  ...
  b8:	3f450513          	addi	a0,a0,1012 # 4a8 <set_priority+0x6c>
  ...
  d4:	3a850513          	addi	a0,a0,936 # 478 <set_priority+0x3c>
  ...
  ee:	3a650513          	addi	a0,a0,934 # 490 <set_priority+0x54>
