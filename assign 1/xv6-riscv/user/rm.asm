...
main(int argc, char *argv[])
{
  ...
  42:	7e258593          	addi	a1,a1,2018 # 820 <malloc+0xec>
  46:	4509                	li	a0,2
  ...
  60:	7dc58593          	addi	a1,a1,2012 # 838 <malloc+0x104>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	47e50513          	addi	a0,a0,1150 # 860 <digits>
 3ea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	3b2b8b93          	addi	s7,s7,946 # 860 <digits>
 ...
 5f2:	26a90913          	addi	s2,s2,618 # 858 <malloc+0x124>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ba:	1c27b783          	ld	a5,450(a5) # 878 <freep>
 ...
 6e8:	00e6ea63          	bltu	a3,a4,6fc <free+0x50>
{
 ...
 72a:	14f73923          	sd	a5,338(a4) # 878 <freep>
}
 72e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75c:	12053503          	ld	a0,288(a0) # 878 <freep>
 ...
 784:	0f890913          	addi	s2,s2,248 # 878 <freep>
  if(p == (char*)-1)
 788:	5afd                	li	s5,-1
 78a:	a895                	j	7fe <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 78c:	00000797          	auipc	a5,0x0
 790:	0f478793          	addi	a5,a5,244 # 880 <base>
 794:	00000717          	auipc	a4,0x0
 798:	0ef73223          	sd	a5,228(a4) # 878 <freep>
 79c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c0:	0aa73e23          	sd	a0,188(a4) # 878 <freep>
      return (void*)(p + 1);
 ...
 80e:	b64080e7          	jalr	-1180(ra) # 36e <sbrk>
  if(p == (char*)-1)
