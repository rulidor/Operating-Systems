...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2fe50513          	addi	a0,a0,766 # 1398 <malloc+0xec>
      a2:	00001097          	auipc	ra,0x1
      a6:	e24080e7          	jalr	-476(ra) # ec6 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2ee50513          	addi	a0,a0,750 # 1398 <malloc+0xec>
      b2:	00001097          	auipc	ra,0x1
      b6:	e1c080e7          	jalr	-484(ra) # ece <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2e450513          	addi	a0,a0,740 # 13a0 <malloc+0xf4>
  ...
  chdir("/");
      ...
      da:	2ea50513          	addi	a0,a0,746 # 13c0 <malloc+0x114>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2ea98993          	addi	s3,s3,746 # 13d0 <malloc+0x124>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2d898993          	addi	s3,s3,728 # 13c8 <malloc+0x11c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	5b4a0a13          	addi	s4,s4,1460 # 16b0 <buf.0>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	2ce50513          	addi	a0,a0,718 # 13d8 <malloc+0x12c>
    ...
    if(what == 1){
     ...
     2a2:	3b258593          	addi	a1,a1,946 # 1650 <malloc+0x3a4>
     ...
     2c6:	39650513          	addi	a0,a0,918 # 1658 <malloc+0x3ac>
     ...
     2e4:	10850513          	addi	a0,a0,264 # 13e8 <malloc+0x13c>
     ...
     36c:	0a050513          	addi	a0,a0,160 # 1408 <malloc+0x15c>
     ...
     38e:	08e50513          	addi	a0,a0,142 # 1418 <malloc+0x16c>
     ...
     3c6:	01650513          	addi	a0,a0,22 # 13d8 <malloc+0x12c>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	afc080e7          	jalr	-1284(ra) # ec6 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	05a50513          	addi	a0,a0,90 # 1430 <malloc+0x184>
     ...
     4b8:	fe450513          	addi	a0,a0,-28 # 1498 <malloc+0x1ec>
     ...
     506:	f9650513          	addi	a0,a0,-106 # 1498 <malloc+0x1ec>
     ...
     518:	94a080e7          	jalr	-1718(ra) # e5e <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0xcb>
     ...
     566:	f4e50513          	addi	a0,a0,-178 # 14b0 <malloc+0x204>
     ...
     592:	eea50513          	addi	a0,a0,-278 # 1478 <malloc+0x1cc>
     ...
     5b4:	ee850513          	addi	a0,a0,-280 # 1498 <malloc+0x1ec>
     ...
     5ce:	ef650513          	addi	a0,a0,-266 # 14c0 <malloc+0x214>
     ...
     61c:	e8050513          	addi	a0,a0,-384 # 1498 <malloc+0x1ec>
     ...
     678:	e6450513          	addi	a0,a0,-412 # 14d8 <malloc+0x22c>
     ...
     6a4:	e5058593          	addi	a1,a1,-432 # 14f0 <malloc+0x244>
     ...
     7a6:	cf650513          	addi	a0,a0,-778 # 1498 <malloc+0x1ec>
     ...
     7c0:	d7c50513          	addi	a0,a0,-644 # 1538 <malloc+0x28c>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6ea080e7          	jalr	1770(ra) # eae <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	d6850513          	addi	a0,a0,-664 # 1538 <malloc+0x28c>
     ...
     7ec:	d0858593          	addi	a1,a1,-760 # 14f0 <malloc+0x244>
     ...
     85e:	cfe50513          	addi	a0,a0,-770 # 1558 <malloc+0x2ac>
     ...
     878:	cfc50513          	addi	a0,a0,-772 # 1570 <malloc+0x2c4>
     ...
     894:	cf850513          	addi	a0,a0,-776 # 1588 <malloc+0x2dc>
     ...
     8ae:	d0650513          	addi	a0,a0,-762 # 15b0 <malloc+0x304>
     ...
     8c8:	c1458593          	addi	a1,a1,-1004 # 14d8 <malloc+0x22c>
     8cc:	4509                	li	a0,2
     ...
     8e4:	bf858593          	addi	a1,a1,-1032 # 14d8 <malloc+0x22c>
     8e8:	4509                	li	a0,2
     ...
     940:	c9c58593          	addi	a1,a1,-868 # 15d8 <malloc+0x32c>
     944:	4509                	li	a0,2
     ...
     9b4:	ae858593          	addi	a1,a1,-1304 # 1498 <malloc+0x1ec>
     9b8:	4509                	li	a0,2
     ...
     a00:	bdc58593          	addi	a1,a1,-1060 # 15d8 <malloc+0x32c>
     a04:	4509                	li	a0,2
     ...
     a44:	b9858593          	addi	a1,a1,-1128 # 15d8 <malloc+0x32c>
     a48:	4509                	li	a0,2
     ...
     aac:	9f058593          	addi	a1,a1,-1552 # 1498 <malloc+0x1ec>
     ab0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	9a850513          	addi	a0,a0,-1624 # 1478 <malloc+0x1cc>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3d6080e7          	jalr	982(ra) # eae <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	94850513          	addi	a0,a0,-1720 # 1428 <malloc+0x17c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b18:	98450513          	addi	a0,a0,-1660 # 1498 <malloc+0x1ec>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	94250513          	addi	a0,a0,-1726 # 1498 <malloc+0x1ec>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f5e:	72e50513          	addi	a0,a0,1838 # 1688 <digits>
     f62:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    102a:	662b8b93          	addi	s7,s7,1634 # 1688 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    116a:	51a90913          	addi	s2,s2,1306 # 1680 <malloc+0x3d4>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1232:	47a7b783          	ld	a5,1146(a5) # 16a8 <freep>
    ...
    1260:	00e6ea63          	bltu	a3,a4,1274 <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    127a:	02059813          	slli	a6,a1,0x20
    127e:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    128e:	02061593          	slli	a1,a2,0x20
    1292:	01c5d713          	srli	a4,a1,0x1c
  ...
  freep = p;
    ...
    12a2:	40f73523          	sd	a5,1034(a4) # 16a8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12d4:	3d853503          	ld	a0,984(a0) # 16a8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12fc:	3b090913          	addi	s2,s2,944 # 16a8 <freep>
  if(p == (char*)-1)
    1300:	5afd                	li	s5,-1
    1302:	a895                	j	1376 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    1304:	00000797          	auipc	a5,0x0
    1308:	79478793          	addi	a5,a5,1940 # 1a98 <base>
    130c:	00000717          	auipc	a4,0x0
    1310:	38f73e23          	sd	a5,924(a4) # 16a8 <freep>
    ...
    131a:	b7e1                	j	12e2 <malloc+0x36>
      if(p->s.size == nunits)
    131c:	02e48c63          	beq	s1,a4,1354 <malloc+0xa8>
        p->s.size -= nunits;
    1320:	4137073b          	subw	a4,a4,s3
    1324:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1326:	02071693          	slli	a3,a4,0x20
    132a:	01c6d713          	srli	a4,a3,0x1c
    132e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1330:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1334:	00000717          	auipc	a4,0x0
    1338:	36a73a23          	sd	a0,884(a4) # 16a8 <freep>
      return (void*)(p + 1);
    133c:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    1340:	70e2                	ld	ra,56(sp)
    1342:	7442                	ld	s0,48(sp)
    1344:	74a2                	ld	s1,40(sp)
    1346:	7902                	ld	s2,32(sp)
    1348:	69e2                	ld	s3,24(sp)
    134a:	6a42                	ld	s4,16(sp)
    134c:	6aa2                	ld	s5,8(sp)
    134e:	6b02                	ld	s6,0(sp)
    1350:	6121                	addi	sp,sp,64
    1352:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    1354:	6398                	ld	a4,0(a5)
    1356:	e118                	sd	a4,0(a0)
    1358:	bff1                	j	1334 <malloc+0x88>
  hp->s.size = nu;
    135a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    135e:	0541                	addi	a0,a0,16
    1360:	00000097          	auipc	ra,0x0
    1364:	ec4080e7          	jalr	-316(ra) # 1224 <free>
  return freep;
    1368:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    136c:	d971                	beqz	a0,1340 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    136e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1370:	4798                	lw	a4,8(a5)
    1372:	fa9775e3          	bgeu	a4,s1,131c <malloc+0x70>
    if(p == freep)
    1376:	00093703          	ld	a4,0(s2)
    137a:	853e                	mv	a0,a5
    137c:	fef719e3          	bne	a4,a5,136e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    1380:	8552                	mv	a0,s4
    1382:	00000097          	auipc	ra,0x0
    1386:	b64080e7          	jalr	-1180(ra) # ee6 <sbrk>
  if(p == (char*)-1)
    138a:	fd5518e3          	bne	a0,s5,135a <malloc+0xae>
        return 0;
    138e:	4501                	li	a0,0
    1390:	bf45                	j	1340 <malloc+0x94>
