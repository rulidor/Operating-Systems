...
fmtname(char *path)
{
  ...
  6a:	aaa98993          	addi	s3,s3,-1366 # b10 <buf.0>
...
malloc(uint nbytes)
{
 ...
 a48:	ec4080e7          	jalr	-316(ra) # 908 <free>
  return freep;
 ...
 a6a:	b64080e7          	jalr	-1180(ra) # 5ca <sbrk>
  if(p == (char*)-1)
